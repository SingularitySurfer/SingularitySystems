...
![Single tone, no scaling](./../python/fft1.pdf){#fft1 width="108%"}

![Single tone, max scaling](./../python/fft2.pdf){#fft2 width="108%"}

![8 tones, scaling last](./../python/fft3.pdf){#fft3 width="108%"}

![8 tones, scaling first](./../python/fft4.pdf){#fft4 width="108%"}

![128 tones, scaling first](./../python/fft5.pdf){#fft5 width="108%"}

![8 tones, bitreversed](./../python/fft6.pdf){#fft6 width="108%"}

![4 cycle square wave](./../python/fft7.pdf){#fft7 width="108%"}
